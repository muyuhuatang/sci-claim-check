...
class Instructor:
    ...
    def _train(self, criterion, optimizer, train_data_loader, val_data_loader):
        ...
        for i_epoch in range(self.opt.num_epoch):
            ...
            val_acc, val_f1, val_pred = self._evaluate_acc_f1(val_data_loader)
    ...
    def _evaluate_acc_f1(self, data_loader):
        ...
        pred = torch.argmax(t_outputs_all, -1).cpu()
        return acc, f1, pred
    ...
    def run(self):
        ...
        test_acc, test_f1, test_pred = self._evaluate_acc_f1(test_data_loader)
